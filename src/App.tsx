...
import { DocsAddressDisplay } from '@/pages/docs/components/address-display';
import { DocsBalanceDisplay } from '@/pages/docs/components/balance-display';
import { DocsNetworkBadge } from '@/pages/docs/components/network-badge';
import { DocsTransactionStatus } from '@/pages/docs/components/transaction-status';
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/docs" element={<DocsLayout />}>
            ...
            />
            <Route
              path="components/wallet-modal"
              element={<DocsWalletModal />}
            />
            <Route
              path="components/address-display"
              element={<DocsAddressDisplay />}
            />
            <Route
              path="components/balance-display"
              element={<DocsBalanceDisplay />}
            />
            <Route
              path="components/network-badge"
              element={<DocsNetworkBadge />}
            />
            <Route
              path="components/transaction-status"
              element={<DocsTransactionStatus />}
            />
